const rawPortfolioData = {
  ...
  "stats": [
    ...
    {
      "value": "24/7",
      "label_key": "stats.support"
    },
    {
      "value": "1M+",
      "label_key": "stats.lines"
    }
  ],
  "projects": [
    {
      ...
      "zh": {
        "title": "平面设计门户",
        "subtitle": "UI设计 / 品牌推广",
        "description": "旨在提供最佳用户体验与现代视觉元素的优质品牌展示平台。"
      },
      "ar": {
        "title": "بوابة التصميم الجرافيكي",
        "subtitle": "تصميم الواجهات / الهوية التجارية",
        "description": "منصة عرض علامة تجارية متميزة مصممة لتقديم تجربة مستخدم مثالية وعناصر مرئية حديثة."
      }
    },
    {
      "id": "project-2",
      ...
      "zh": {
        "title": "演示汇报平台",
        "subtitle": "Web应用程序",
        "description": "支持低延迟渲染的交互式幻灯片和演示托管控制面板。"
      },
      "ar": {
        "title": "منصة العروض التقديمية",
        "subtitle": "تطبيق ويب",
        "description": "لوحة تحكم تفاعلية لاستضافة العروض الشرائحية والتقديمية مع رندر منخفض الكمون."
      }
    },
    {
      "id": "project-3",
      ...
      "zh": {
        "title": "UI组件套件",
        "subtitle": "设计系统",
        "description": "一套功能强大、完全无障碍的设计系统，支持深色模式与CSS变量配置。"
      },
      "ar": {
        "title": "حزمة مكونات واجهات المستخدم",
        "subtitle": "نظام تصميم",
        "description": "نظام تصميم قوي ويمكن الوصول إليه بالكامل يتميز بالوضع الداكن وتكوين متغيرات CSS."
      }
    },
    {
      "id": "project-4",
      ...
      "zh": {
        "title": "材料设计应用",
        "subtitle": "移动端界面",
        "description": "遵循谷歌材料设计（Material Design）规范的跨平台移动端应用。"
      },
      "ar": {
        "title": "تطبيق ماتيريال ديزاين",
        "subtitle": "واجهة الهاتف المحمول",
        "description": "تطبيق للهاتف المحمول عبر المنصات يتبع إرشادات تصميم ماتيريال من جوجل."
      }
    },
    {
      "id": "project-5",
      ...
      "zh": {
        "title": "社媒发帖仪表盘",
        "subtitle": "Web应用程序",
        "description": "用于动态管理和安排社交媒体帖子发布的分析控制面板。"
      },
      "ar": {
        "title": "لوحة تحكم منشورات التواصل",
        "subtitle": "تطبيق ويب",
        "description": "لوحة تحكم تحليلية لإدارة وجدولة منشورات وسائل التواصل الاجتماعي بشكل ديناميكي."
      }
    }
  ],
  "services": [
    {
      ...
      "zh": {
        "title": "Web开发",
        "description": "构建专为高性能定制的快速、可扩展且安全的Web应用。",
        "features": [
          "响应式布局（移动端、平板、电脑）",
          "现代框架集成（React, Angular）",
          "SEO优化与元数据结构设计",
          "极速页面加载与核心网页指标优化"
        ]
      },
      "ar": {
        "title": "تطوير الويب",
        "description": "بناء تطبيقات ويب سريعة وقابلة للتطوير وآمنة مصممة للأداء العالي.",
        "features": [
          "تخطيطات متجاوبة (هاتف، تابلت، ديسكتوب)",
          "تكامل إطارات العمل الحديثة (React, Angular)",
          "تهيئة محركات البحث وهيكلة البيانات",
          "سرعة تحميل الصفحات وتهيئة Core Web Vitals"
        ]
      }
    },
    {
      ...
      "zh": {
        "title": "跨平台开发",
        "description": "使用现代混合技术在移动平台上创建无缝体验。",
        "features": [
          "React Native 和 Flutter 移动应用程序",
          "共享代码库以提高开发速度",
          "原生 API 集成与性能调优",
          "应用商店部署支持（App Store, Play Store）"
        ]
      },
      "ar": {
        "title": "تطوير التطبيقات عبر المنصات",
        "description": "إنشاء تجارب سلسة على منصات الهاتف المحمول باستخدام تقنيات هجينة حديثة.",
        "features": [
          "تطبيقات الهواتف باستخدام React Native و Flutter",
          "قاعدة كود مشتركة لسرعة تطوير عالية",
          "تكامل واجهات التطبيقات البرمجية والأداء",
          "دعم النشر على المتاجر (آبل ستور وجوجل بلاي)"
        ]
      }
    },
    {
      ...
      "zh": {
        "title": "UI/UX 设计",
        "description": "设计符合市场需求并提高用户转化率的视觉旅程。",
        "features": [
          "交互式原型设计与用户测试流程",
          "现代排版与色彩系统设计",
          "矢量插图与自定义 SVG 创作",
      ...
      "ar": {
        ...
        "description": "تصميم رحلات مرئية تلبي احتياجات السوق وتعزز تحويلات المستخدمين.",
        "features": [
          "النماذج الأولية التفاعلية واختبار المستخدم",
          "أنظمة الألوان والخطوط الحديثة",
          "رسومات فيكتور ورسومات SVG مخصصة",
          "تحويل تصاميم فيجما إلى كود جاهز للإنتاج"
        ]
      }
    }
  ],
  "experiences": [
    ...
    },
    {
      ...
      "zh": {
        "role": "软件开发培训生",
        "company": "维布络 Wipro（合同制）"
      },
      "ar": {
        "role": "متدرب برمجيات",
        "company": "ويبرو (عقد عمل)"
      }
    },
    {
      ...
      "zh": {
        "role": "前端开发工程师",
        "company": "马恒达 Tech Mahindra（合同制 - 远程）"
      },
      "ar": {
        "role": "مطور واجهات مستخدم",
        "company": "تيك ماهيندرا (عقد - عن بعد)"
      }
    },
    {
      ...
      "zh": {
        "role": "学生实习生",
        "company": "Micropro Infotech（实习）"
      },
      "ar": {
        "role": "طالب متدرب",
        "company": "مايكروبرو إنفوتيك (فترة تدريب)"
      }
    }
  ],
  "testimonials": [
    {
      ...
      "logo_url": "assets/img/Jabali-LogoNoWords-200x205.webp",
      "en": {
        "name": "Jabali Int.",
      ...
      "zh": {
        "name": "Jabali 国际公司",
        "role": "客户代表",
        "text": "工作完成得非常出色，项目的各个方面得已很好解决。极具创意和远见。给我留下了深刻的印象，强烈向大家推荐。"
      },
      "ar": {
        "name": "جابالي العالمية",
        "role": "ممثل العملاء",
        "text": "عمل رائع حقاً، تم إنجاز جميع جوانب المشروع بشكل جيد. مبدع للغاية ومدروس. لقد أعجبت جداً وسأوصي به لأي شخص."
      }
    },
    {
      "logo_class": "brac",
      "avatar_url": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&h=100&q=80",
      "logo_url": "assets/img/BRAC-Mark-Icon-BRAC-UPGI.webp",
      "en": {
        "name": "Brac HRMS HEAD",
      ...
      "zh": {
        "name": "Brac HRMS 部门主管",
        "role": "企业客户",
        "text": "工作按时交付了。甚至在截止日期之前就拿到了我的产品。对这次合作非常满意，在此极力向各位推荐他。"
      },
      "ar": {
        "name": "رئيس Brac HRMS",
        "role": "عميل مؤسسي",
        "text": "لقد انتهى عملي في الوقت المحدد. حصلت على تسليم منتجي قبل تاريخ الاستحقاق. أنا سعيد جداً بالعمل، ويمكنني أن أقترحه لكم جميعاً."
      }
    },
    {
      ...
      "logo_url": "assets/img/unnamed.webp",
      "en": {
        "name": "Talikhata CTO",
        "role": "Tech Partner",
      ...
      "zh": {
        "name": "Talikhata 首席技术官",
        "role": "技术合作伙伴",
        "text": "非常谦虚且乐于助人，工作非常准时。按时拿到了产品交付。非常满意并极力推荐他。"
      },
      "ar": {
        "name": "المدير التقني لـ Talikhata",
        "role": "شريك تقني",
        "text": "شخص متواضع وداعم للغاية，ودقيق جداً في عمله. حصلت على تسليم منتجي في الوقت المناسب. أنا معجب جداً وسأوصي به."
      }
    }
  ],
  "faqs": [
    {
      ...
      "zh": {
        "question": "您通常承接什么类型的项目？",
        "answer": "我专注于Web开发、跨平台移动应用程序（React Native / Flutter）开发以及UI/UX设计。从早期原型设计到企业级生产就绪的软件系统，我都能提供专业的研发支持。"
      },
      "ar": {
        "question": "ما هي نوعية المشاريع التي تعمل عليها؟",
        "answer": "أنا متخصص في تطوير الويب، تطبيقات الهواتف المحمولة عبر المنصات (React Native / Flutter)، وتصميم الواجهات UI/UX. أعمل على كل شيء بدءاً من النماذج الأولية وحتى الأنظمة البرمجية الجاهزة للإنتاج للمؤسسات."
      }
    },
    {
      "id": "faq-2",
      ...
      "zh": {
        "question": "您接受自由职业或全职远程工作吗？",
        "answer": "是的，我接受自由职业项目和远程全职岗位。我正在积极寻求全球合作机会，充分发挥我的前端工程专业技能。"
      },
      "ar": {
        "question": "هل تقبل العمل المستقل أو العمل بدوام كامل؟",
        "answer": "نعم，أنا منفتح على المشاريع المستقلة ووظائف العمل عن بعد بدوام كامل. أبحث بنشاط عن فرص عالمية حيث يمكنني المساهمة بمهاراتي في هندسة واجهات المستخدم."
      }
    },
    {
      "id": "faq-3",
      ...
      "zh": {
        "question": "您的项目工作流是怎样的？",
        "answer": "我的工作流程包含三个明确的步骤：（1）定义与架构——收集需求并设计用户体验；（2）构建与开发——编写干净、模块化且经过优化的代码；（3）部署与支持——部署生产级代码并提供发布后的技术支持。"
      },
      "ar": {
        "question": "كيف تبدأ العمل على المشاريع الجديدة؟",
        "answer": "تتضمن آلية عملي ثلاث خطوات واضحة: (1) التعريف والتهيئة - جمع المتطلبات وتصميم تجارب المستخدم؛ (2) البناء والتطوير - كتابة كود نظيف ومجزأ ومحسن؛ (3) النشر والدعم - نشر الكود بمستوى الإنتاج وتقديم الدعم."
      }
    },
    {
      "id": "faq-4",
      ...
      "zh": {
        "question": "一般项目的周期是多久？",
        "answer": "项目周期取决于复杂程度。小型着陆页或UI系统通常需要1-2周，而完整的企业级Web应用程序或跨平台移动应用则需要4-8周。"
      },
      "ar": {
        "question": "ما هو الجدول الزمني المعتاد للمشروع؟",
        "answer": "تختلف الجداول الزمنية حسب التعقيد. قد تستغرق صفحات الهبوط الصغيرة أو أنظمة الواجهات أسبوعاً أو أسبوعين، بينما قد يتطلب بناء تطبيقات الويب الكبيرة للمؤسسات أو تطبيقات الموبايل من 4 إلى 8 أسابيع."
      }
    },
    {
      "id": "faq-5",
      ...
      "zh": {
        "question": "我们如何开始合作？",
        "answer": "您可以通过联系我们区域的链接，通过电子邮件、领英（LinkedIn）或WhatsApp与我取得联系。我们可以安排一次通话，详细讨论您的项目需求！"
      },
      "ar": {
        "question": "كيف يمكننا البدء؟",
        "answer": "يمكنك التواصل معي عبر البريد الإلكتروني، لينكد إن، أو واتساب باستخدام الروابط الموجودة في قسم الاتصال. لنحدد موعداً لمكالمة لمناقشة متطلبات مشروعك بالتفصيل!"
      }
    }
  ],
  "i18n": {
    ...
    "zh": {
      ...
      "hero": {
        "greeting": "你好，我是 Hredoy Sen，致力于构建",
        "span_bold": "数字化体验。",
        "subtitle": "从原型设计到生产就绪系统，我将创意转化为可扩展的、以用户为中心的产品。",
        "connect_btn": "取得联系",
        "work_btn": "查看作品",
        "trusted_by": "合作伙伴:"
      },
      "projects_section": {
        "title": "最近项目",
        "subtitle": "精选项目集——合理、快速、面向未来——完美结合了设计、编码与创意。",
        "filter_all": "全部",
        "filter_app": "应用",
        "filter_web": "网页",
        "filter_design": "设计",
      ...
      "services_section": {
        "title": "服务项目",
        "subtitle": "从原型设计到全栈，我构建可扩展且用户友好的现代化产品。"
      },
      "process_section": {
        "title": "工作流程",
        "subtitle": "清晰的工作流程驱动着每一个项目——从策略和设计到开发和发布后的技术支持。",
        "step_1_title": "定义与架构",
        "step_1_desc": "定义目标，规划工作流，并设计适合于可扩展UI的干净布局。",
        "step_2_title": "构建与开发",
        "step_2_desc": "利用最先进的技术编写干净、健壮且可重用的代码。",
        "step_3_title": "部署与支持",
        "step_3_desc": "部署到生产环境并提供积极的发布后技术支持。",
        "banner_text": "用专业的代码构建可靠的、以用户为中心的产品。"
      },
      "about_section": {
        "title": "关于我",
        "subtitle": "我构建直观的数字化产品——可扩展、高性能，且通过通力合作完成。",
        "status_tag": "可接受新项目",
        "brief_bio": "使用最佳技术创建无缝性能界面、移动端并进行开发",
        "bio_greeting": "你好！我是 Hredoy Sen,",
        "long_bio": "我是一名充满热情的资深软件工程师，在 Angular、React、React Native 和 Flutter 领域拥有专业知识，专注于前端开发和跨平台应用。凭借 5 年以上的经验，我构建了可扩展、用户友好的 Web 和移动应用，专注于无缝的用户体验、性能和可维护性。目前，我在 BRAC IT 担任高级软件工程师，开发企业级应用并引入前端测试实践。",
        "tech_stack_title": "我的技术栈:",
        "experience_title": "项目经验"
      },
      "faq_section": {
        "title": "常见问题解答",
        "subtitle": "解答关于我的工作和流程的常见问题。"
      },
      "testimonials_section": {
        "title": "客户见证",
        "subtitle": "来自客户和合作者的反馈，反映了我对质量和可靠性的承诺。"
      },
      "cta_section": {
        "title": "您的愿景，我的专业。让我们携手创造 <span class=\"cta__highlight\">非凡的作品。</span>",
        "subtitle": "准备好开始了吗？预约咨询，让我们共同规划您的下一个项目。",
        "button": "预约通话"
      },
      "contact_section": {
        "title": "联系我",
        ...
        "form_title": "给我发送您的留言",
        "form_name": "姓名",
        "form_name_placeholder": "输入姓名",
        "form_email": "邮箱",
        "form_email_placeholder": "输入邮箱",
        "form_message": "留言内容",
        "form_message_placeholder": "在此输入您的留言内容",
        "form_submit": "发送留言"
      },
      "footer": {
        "rights": "版权所有。",
    ...
    "ar": {
      ...
      "hero": {
        "greeting": "مرحباً، أنا هريدوي سين، أقوم ببناء",
        "span_bold": "تجارب رقمية.",
        "subtitle": "من النماذج الأولية إلى الأنظمة الجاهزة للإنتاج، أقوم بتحويل الأفكار إلى منتجات قابلة للتوسع وتركز على المستخدم.",
        "connect_btn": "اتصل بنا",
        "work_btn": "رؤية أعمالي",
        "trusted_by": "شركاء النجاح:"
      },
      "projects_section": {
        "title": "المشاريع الحديثة",
        "subtitle": "مزيج منسق من المشاريع - عملية وسريعة وجاهزة للمستقبل - تمزج بين التصميم والكود والإبداع.",
        "filter_all": "الكل",
        "filter_app": "التطبيقات",
      ...
      "services_section": {
        "title": "خدماتنا",
        "subtitle": "من النماذج الأولية إلى التطوير الشامل، أقوم ببناء منتجات حديثة قابلة للتطوير وسهلة الاستخدام."
      },
      "process_section": {
        "title": "سير العمل",
        "subtitle": "آلية عمل واضحة توجه كل مشروع - بدءاً من الاستراتيجية والتصميم وحتى التطوير والدعم بعد الإطلاق.",
        "step_1_title": "التعريف والتهيئة",
        "step_1_desc": "تحديد الأهداف، ورسم خرائط سير العمل، وتخطيط واجهات نظيفة للمستقبل.",
        "step_2_title": "البناء والتطوير",
        "step_2_desc": "كتابة تعليمات برمجية نظيفة وقوية وقابلة لإعادة الاستخدام باستخدام أحدث التقنيات.",
        "step_3_title": "النشر والدعم",
        "step_3_desc": "النشر في بيئات الإنتاج وتقديم دعم نشط بعد الإطلاق.",
        "banner_text": "بناء منتجات موثوقة تركز على المستخدم بكود برمجي متقن."
      },
      "about_section": {
        "title": "من أنا",
        "subtitle": "أقوم ببناء منتجات رقمية سهلة الاستخدام - قابلة للتطوير وعالية الأداء وتتم بالتعاون المشترك.",
        "status_tag": "متاح للعمل حالياً",
        "brief_bio": "إنشاء واجهات أداء سلسة وتطوير للهواتف بأفضل التقنيات",
        "bio_greeting": "مرحباً! أنا هريدوي سين،",
        "long_bio": "أنا مهندس برمجيات أول شغوف ولدي خبرة في Angular و React و React Native و Flutter، ومتخصص في تطوير واجهات المستخدم والتطبيقات عبر المنصات. مع أكثر من 5 سنوات من الخبرة، قمت ببناء تطبيقات ويب وهواتف محمولة قابلة للتطوير وسهلة الاستخدام، مع التركيز على تجربة المستخدم السلسة والأداء وقابلية الصيانة. حالياً، أعمل كمهندس برمجيات أول في BRAC IT، حيث أقوم بتطوير تطبيقات على مستوى المؤسسات.",
        "tech_stack_title": "تقنياتي البرمجية:",
        "experience_title": "الخبرة المهنية"
      },
      "faq_section": {
        "title": "الأسئلة الأكثر شيوعاً",
        "subtitle": "إجابات على الأسئلة الشائعة حول عملي وآليتي."
      },
      "testimonials_section": {
        "title": "آراء العملاء",
        "subtitle": "ملاحظات من العملاء والمتعاونين، تعكس التزامي بالجودة والموثوقية."
      },
      "cta_section": {
        "title": "رؤيتك، خبرتي. لنصنع شيئاً <span class=\"cta__highlight\">استثنائياً.</span>",
        "subtitle": "جاهز للبدء؟ حدد موعداً للاستشارة ولنبدأ في تشكيل مشروعك القادم.",
        "button": "احجز مكالمة"
      },
      "contact_section": {
        "title": "تواصل معي",
        "subtitle": "كن على اتصال",
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = rawPortfolioData;
} else {
  window.portfolioData = rawPortfolioData;
}
